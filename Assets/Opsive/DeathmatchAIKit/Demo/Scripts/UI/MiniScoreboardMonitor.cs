...
namespace Opsive.DeathmatchAIKit.Demo.UI
{
    ...
    public class MiniScoreboardMonitor : CharacterMonitor
    {
        ...
        protected class ScoreContainer
        {
            ...
            [SerializeField] protected Shared.UI.Text m_Score;
            ...
            public Shared.UI.Text Score { get { return m_Score; } }
        ...
        protected override void Start()
        {
            ...
            if (DeathmatchManager.ObserverMode) {
                ...
                m_LocalPlayer.Name.gameObject.transform.parent.gameObject.SetActive(false);
            }
        }
        ...
        private void ScoreChange()
        {
            ...
            if (m_Character != null) {
                ...
                m_LocalPlayer.Name.SetText(localPlayerStats.Name);
                m_LocalPlayer.Score.SetText(localPlayerStats.Kills.ToString());
                m_LocalPlayer.Background.color = colors[localPlayerStats.TeamIndex];
            }
            m_Leader.Name.SetText(m_Scoreboard.NonLocalPlayerLeader.Name);
            m_Leader.Score.SetText(m_Scoreboard.NonLocalPlayerLeader.Kills.ToString());
